...
INSERT INTO product (id, creator_id, name,  quantity, price, description)
VALUES  (1, 4, 'Смішна футболка', 10, 600, 'Смішна футболка'),
    	(2, 4, 'Смішна кружка', 5, 280, 'Смішна кружка'),
    	(3, 5, 'Діамантове кольє', 20, 1500, 'Діамантове кольє'),
    	(4, 5, 'Золотий браслет', 15, 1200, 'Золотий браслет'),
    	(5, 6, 'Вишивана подушка', 8, 1000, 'Вишивана подушка'),
    	(6, 6, 'Вишиваний рушник', 12, 550, 'Вишиваний рушник'),
    	(7, 7, 'Шкіряна куртка', 25, 2800, 'Шкіряна куртка'),
    	(8, 7, 'Шкіряна сумка', 18, 1900, 'Шкіряна сумка'),
    	(9, 4, 'Смішна шапка', 30, 150, 'Смішна шапка'),
    	(10, 6, 'Вишивана сукня', 10, 800, 'Вишивана сукня');
